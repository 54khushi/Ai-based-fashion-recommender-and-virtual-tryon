...
while cap.isOpened():
    ...
    if hands_results.multi_hand_landmarks:
        for hand_landmarks in hands_results.multi_hand_landmarks:
            ...
            if x > image.shape[1] - imgButtonRight.shape[1] - 10 and y > image.shape[0] // 2 - imgButtonRight.shape[
                0] // 2 and y < image.shape[0] // 2 + imgButtonRight.shape[0] // 2:
                counterRight += 1
            ...
            elif x < imgButtonLeft.shape[1] + 10 and y > image.shape[0] // 2 - imgButtonLeft.shape[0] // 2 and y < \
                    image.shape[0] // 2 + imgButtonLeft.shape[0] // 2:
                counterLeft += 1
